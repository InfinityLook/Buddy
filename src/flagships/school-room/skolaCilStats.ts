...
//
// spocitejProcentaCileProumeru se odsud přesunula do znamky/types.ts —
// je to obecná funkce o jedné/celkové klasifikační známce, ne o School
// Roomu samotném, a miniaplikace nesmí importovat z vlajkové appky.
// ==========================================
