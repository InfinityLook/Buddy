...
export const ProfilIcon: React.FC<ProfilIconProps> = ({ name, size = 20, className }) => {
  ...
  switch (name) {
    ...
    case 'fingerprint':
      return <svg {...common}><path d="M12 10a2 2 0 0 0-2 2c0 1.5-.5 4-2 6"/><path d="M6.5 8.5A5.5 5.5 0 0 1 17.5 10c0 1.2-.1 2.3-.3 3.4"/><path d="M17.5 10c0 3-1 5-2 6.5"/><path d="M2.9 12.5C2.9 8.4 6.4 5 12 5s9.1 3.4 9.1 7.5"/><path d="M12 10a2 2 0 0 1 2 2c0 2.5 1 4.5 2.5 6"/><path d="M8.5 14.5c-.3 1.7-1 3-2 4.2"/></svg>
    case 'bell-ring':
      return <svg {...common}><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/><path d="M4 2C2.8 3 2 4.5 2 6"/><path d="M20 2c1.2 1 2 2.5 2 4"/></svg>
    case 'trash':
