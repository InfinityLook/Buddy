...
const DEFAULT_APPS: AppItem[] = [
  ...
  { id: 'economy-room', title: 'Economy Room', category: 'Nástroje', icon: 'finance', color: 'green', active: true, favorite: false, route: '/economy', nahled: '/backgrounds/economy-room.png', jenVeVlajkoveAppce: true },
