...
export const SocialIcon: React.FC<SocialIconProps> = ({ name, size = 20, className }) => {
  ...
  switch (name) {
    ...
    case 'pencil':
      return <svg {...common}><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>
    case 'attach':
    ...
    case 'mic':
      return <svg {...common}><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 10a7 7 0 0 0 14 0"/><path d="M12 19v3"/></svg>
    case 'play':
      return <svg {...common} fill="currentColor"><path d="M7 4v16l14-8z"/></svg>
    case 'pause':
    ...
    // Nákupní taška (Shop dlaždice v Hubu) — obrys, žádná výplň, stejný
    // jazyk jako zbytek sady.
    case 'bag':
    ...
    // Cloud (Cloud dlaždice v Hubu — uložená data).
    case 'cloud':
      return <svg {...common}><path d="M17.5 19H9a7 7 0 1 1 6.71-9h.79a4.5 4.5 0 1 1 0 9Z"/></svg>
    // Mřížka (Apps dlaždice v Hubu).
    case 'grid':
      return <svg {...common}><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
    // Ovladač (Play dlaždice v Hubu — herní hub).
    case 'gamepad':
      return <svg {...common}><rect x="2" y="6" width="20" height="12" rx="6"/><path d="M6 12h4"/><path d="M8 10v4"/><path d="M15 13h.01"/><path d="M18 11h.01"/></svg>
